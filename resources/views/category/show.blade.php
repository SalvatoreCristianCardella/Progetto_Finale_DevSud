                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-7 d-flex flex-column align-items-center justify-content-center ">
                            ...
                            @endauth  
                            @else
                            <p><a data-bs-toggle="offcanvas" data-bs-target="#registrati" role="button" id="btn-open-register" class="d-inline text-decoration-none ">Registrati</a> o effettua il 
                            <a data-bs-toggle="offcanvas" data-bs-target="#login" role="button" id="btn-open-login" class="d-inline text-decoration-none">Login</a>
                            </h2>
                        </p>
                           @endif
                        </div>
